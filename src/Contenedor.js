...
class Contenedor {
    ...
    async deleteById(id) {
        try {
            ...
            console.log(
                `There was an error when trying to delete an element by its ID (${id})`
            );
        }
    }
    ...
    async updateById(id, newData) {
        try {
            ...
            `There was an error when trying to update an element by its ID (${id})`;
        }
    }
    ...
    async deleteAll() {
        try {
            ...
            console.log(
                `There was an error (${error.code}) when trying to delete all the elements in the file`
            );
        }
    }
